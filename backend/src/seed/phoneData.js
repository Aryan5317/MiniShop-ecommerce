...
const seedingPhoneData = [
    {
        phoneName: "Redmi A3", phoneImages: ["https://res.cloudinary.com/dpbsi7b4y/image/upload/v1772697728/Redmi_A3images_rwxao2.webp"], phoneBrand: "Redmi", color: "Olive Green", phoneStorage: 128, phoneRam: 4, phoneCondition: "new", category: "Ultra Budget", description: {
        ...
        }, currentPrice: 7239, oldPrice: 11990, discount: 47, returning: 1, addToCart: false, stock: 10, reviews: [], totalSell: 0,
    },
    {
        phoneName: "Realme C51", phoneBrand: "Realme", phoneImages: ["https://res.cloudinary.com/dpbsi7b4y/image/upload/v1772698172/Realme_C51_llfmfx.webp"], color: "Mint Green", phoneStorage: 64, phoneRam: 4, phoneCondition: "new", category: "Ultra Budget", description: {
        ...
        }, currentPrice: 8999, oldPrice: 11000, discount: 20, returning: 1, addToCart: false, stock: 10, reviews: [], totalSell: 0,
    },
    {
        phoneName: "Samsung Galaxy A05", phoneBrand: "Samsung", phoneImages: ["https://res.cloudinary.com/dpbsi7b4y/image/upload/v1772698160/Samsung_Galaxy_A05_rwv7le.webp"], color: "Light Green", phoneStorage: 128, phoneRam: 6, phoneCondition: "new", category: "Budget", description: {
        ...
        }, currentPrice: 12999, oldPrice: 14999, discount: 20, returning: 1, addToCart: false, stock: 10, reviews: [], totalSell: 0,
    },
    {
        phoneName: "Tecno Spark Go 2024", phoneBrand: "Tecno", phoneImages: ["https://res.cloudinary.com/dpbsi7b4y/image/upload/v1772698160/Tecno_Spark_Go_2024_ggii11.webp"], color: "Gravity Black", phoneStorage: 64, phoneRam: 4, phoneCondition: "new", category: "Ultra Budget",
        description: {
        ...
        currentPrice: 8999, oldPrice: 11999, discount: 30, returning: 1, addToCart: false, stock: 10, reviews: [], totalSell: 0,
    },
    {
        phoneName: "Tecno Spark Go 2024", phoneBrand: "Tecno", phoneImages: ["https://res.cloudinary.com/dpbsi7b4y/image/upload/v1772698160/Tecno_Spark_Go_2024_ggii11.webp"], color: "Gravity Black", phoneStorage: 64, phoneRam: 4, phoneCondition: "new", category: "Ultra Budget",
        description: {
