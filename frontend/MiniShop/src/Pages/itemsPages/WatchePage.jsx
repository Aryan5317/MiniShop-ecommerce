...
import Watches from "../../components/component2/Watches"
import WatchesDektopScreenFilter from "../../components/component2/WatchesDektopScreenFilter"
...
function WatchePage() {
  ...
  const imageUrl = "https://res.cloudinary.com/dpbsi7b4y/image/upload/v1775116184/Gemini_Generated_Image_6gm0376gm0376gm0_tescfl.png"
    ...
    <div>
      {isLoggedIn && <div>
        ...
        <div className="flex w-full min-h-screen border bg-white">
          <WatchesDektopScreenFilter setFilterValue={setFilterValue}/>
          <Watches filterValue={filterValue} />
        </div>
        <PhoneOptions />
        <Footer />
      </div>}
