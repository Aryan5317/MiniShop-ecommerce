...
import ShoesDesktopScreenFilter from "../../components/component2/ShoesDesktopScreenFilter"
import Shoes from "../../components/component2/Shoes"

function ShoesPage() {
  const navigate = useNavigate()
  const { isLoggedIn } = useContext(propContext)
  const imageUrl = "https://res.cloudinary.com/dpbsi7b4y/image/upload/v1775116322/Gemini_Generated_Image_8ueuzz8ueuzz8ueu_q2uzff.png"
    ...
    <div>
      {isLoggedIn && <div>
        ...
        <div className="flex w-full min-h-screen border bg-white">
          <ShoesDesktopScreenFilter setFilterValue={setFilterValue}/>
          <Shoes filterValue={filterValue}/>
        </div>
        <PhoneOptions />
        <Footer />
      </div>}
