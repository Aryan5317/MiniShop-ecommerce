...
import Clothes from "../../components/component2/Clothes"
import ClothesDesktopScreenFilter from "../../components/component2/ClothesDesktopScreenFilter"
...
function ClothesPage() {
  ...
  const imageUrl = "https://res.cloudinary.com/dpbsi7b4y/image/upload/v1775115156/Screenshot_2026-04-02_130200_mgz4ve.png"
    ...
    <div>
      {isLoggedIn && <div>
        ...
        <div className="flex w-full min-h-screen border bg-white">
          <ClothesDesktopScreenFilter setFilterValue={setFilterValue}/>
          <Clothes filterValue={filterValue}/>
        </div>
        <PhoneOptions />
        <Footer />
      </div>}
