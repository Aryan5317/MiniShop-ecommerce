...
import EarPhonesDesktopScreenFilter from "../../components/component2/EarPhonesDesktopScreenFilter"
import EarPhone from "../../components/component2/EarPhone"
...
function EarPhonesPage() {
  ...
  const imageUrl = "https://res.cloudinary.com/dpbsi7b4y/image/upload/v1775115630/Gemini_Generated_Image_ii86w6ii86w6ii86_struvq.png"
    ...
    <div>
      {isLoggedIn && <div>
        ...
        <div className="flex w-full min-h-screen border bg-white">
          <EarPhonesDesktopScreenFilter setFilterValue={setFilterValue} />
          <EarPhone filterValue={filterValue}/>
        </div>
        <PhoneOptions />
        <Footer />
      </div>}
